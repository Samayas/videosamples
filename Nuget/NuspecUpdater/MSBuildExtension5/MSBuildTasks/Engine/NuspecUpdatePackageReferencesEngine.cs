...
namespace MSBuildTasks.Engine
{
    ...
    {
        public static void GetAllPackageReferencesFromProjectFile(string nuspecFile, IList<PackageReference> packageReferences, TaskLoggingHelper log)
        {
            log.LogMessage(MessageImportance.High, $"Updating file {nuspecFile}");
            ...
            {
                log.LogMessage(MessageImportance.High, $"verifying  PackageReference name {packageReference.PackageName} with version {packageReference.PackageVersion}");
