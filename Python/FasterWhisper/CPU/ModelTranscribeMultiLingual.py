...
def transcribe(audio_file: str, models_dir: str = None) -> None:
    ...
    segments, info = model.transcribe(audio_file, beam_size=5, best_of=5, multilingual=True, vad_filter=True, vad_parameters=dict(min_silence_duration_ms=400),
        condition_on_previous_text=False, language_detection_segments=3, word_timestamps=False)
